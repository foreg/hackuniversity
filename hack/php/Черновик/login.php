        ...
        <div><!--старый юзер-->
            <form id="login3" class="vhod">
                <fieldset id="inputs">
                    ...
                    <input type="text" name="Email" value="dmitrystrokov@mail.ru" placeholder="Логин">
                    <p class="Bold">Введите пароль</p>
                    <input type="password" name="Password" value="Qwerty" placeholder="Пароль">
                    <fieldset id="actions">
